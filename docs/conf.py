...
latex_documents = [
    (master_doc, 'shellp.tex', 'shellp Documentation',
     'Dull Bananas', 'manual'),
]
...
man_pages = [
    (master_doc, 'shellp', 'shellp Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'shellp', 'shellp Documentation',
     author, 'shellp', 'One line description of project.',
     'Miscellaneous'),
]
